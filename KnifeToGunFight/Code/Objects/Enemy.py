...
class Enemy(GameObject):
    ...
    def Shoot(self, player):
        ...
        # When creating a game object, the coordinates of the top-left corner are supplied.
        laser = Laser(
            self.Coordinates.topleft[0],
            self.Coordinates.topleft[1],
            Laser.Color.Red,
            trajectory_to_player)
